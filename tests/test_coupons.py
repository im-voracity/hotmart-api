...
class TestSales(unittest.TestCase):
    ...
    def test_create_coupon(self, mock_req_with_token):
        ...
        mock_req_with_token.assert_called_once_with(
            method="post",
            url=expected_url,
            body={"code": coupon_code, "discount": coupon_discount},
        )
    ...
    def test_get_coupon(self, mock_req_with_token):
        ...
        mock_req_with_token.assert_called_once_with(
            method="get", url=expected_url, params={"code": coupon_code}, enhance=True
        )
    ...
    def test_delete_coupon(self, mock_req_with_token):
        ...
        expected_url = (
            f"https://developers.hotmart.com/payments/api/v1/coupon/{coupon_id}"
        )
