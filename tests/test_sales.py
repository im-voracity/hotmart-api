...
class TestSales(unittest.TestCase):
    ...
    def test_get_sales_history(self, mock_req_with_token):
        ...
        mock_req_with_token.assert_called_once_with(
            method="get",
            url=expected_url,
            params={"buyer_name": "Paula", "payment_type": "BILLET"},
            enhance=True,
        )
    ...
    def test_get_sales_participants(self, mock_req_with_token):
        ...
        self.hotmart.get_sales_participants(
            buyer_name="Paula", transaction_status="APPROVED"
        )
        ...
        mock_req_with_token.assert_called_once_with(
            method="get",
            url=expected_url,
            params={"buyer_name": "Paula", "transaction_status": "APPROVED"},
            enhance=True,
        )
    ...
    def test_get_sales_commissions(self, mock_req_with_token):
        ...
        self.hotmart.get_sales_commissions(
            commission_as="PRODUCER", transaction_status="APPROVED"
        )
        expected_url = (
        ...
        mock_req_with_token.assert_called_once_with(
            method="get",
            url=expected_url,
            params={"commission_as": "PRODUCER", "transaction_status": "APPROVED"},
            enhance=True,
        )
    ...
    def test_get_sales_price_details(self, mock_req_with_token):
        ...
        self.hotmart.get_sales_price_details(
            payment_type="CREDIT_CARD", transaction_status="APPROVED"
        )
        expected_url = (
        ...
        mock_req_with_token.assert_called_once_with(
            method="get",
            url=expected_url,
            params={"payment_type": "CREDIT_CARD", "transaction_status": "APPROVED"},
            enhance=True,
        )
